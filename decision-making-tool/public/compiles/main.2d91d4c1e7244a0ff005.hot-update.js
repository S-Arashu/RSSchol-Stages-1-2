...
function createChoosePage() {
    ...
    let startAngle = 0;
    let currentTitle = '';
    function drawWheel(progress, totalDegree) {
        if (ctx) {
            ...
            sections.forEach((section, index) => {
                ...
                if (progress && totalDegree) {
                    if (progress >= 1) {
                        const wheelAngle = (startAngle + (360 - (totalDegree % 360))) % 360;
                        if (wheelAngle >= startAngle && wheelAngle < startAngle + angles[index]) {
                            currentTitle = sectionNames[index];
                        }
                    }
                }
            ...
            ctx.fillText(currentTitle, centerX, centerY + radius + 20);
        }
    }
    function spinWheel(duration) {
        ...
        function animate(timestamp) {
            ...
            startAngle = (totalDegree * (1 - progress)) % 360;
            drawWheel(progress, totalDegree);
            if (progress < 1) {
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("3775f456963f046594bb")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.2d91d4c1e7244a0ff005.hot-update.js.map