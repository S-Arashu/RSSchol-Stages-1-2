    ...
    startButton.addEventListener('click', () => {
        if (+timeField.value >= 5 && +timeField.value <= 30) {
            ...
            window.setTimeout(() => {
                ...
                (0,_createAudio__WEBPACK_IMPORTED_MODULE_1__.createAudio)('win', '../../public/sounds/sounds_win.mp3');
                if (!isSound) {
            ...
            (0,_createAudio__WEBPACK_IMPORTED_MODULE_1__.createAudio)('squeak', '../../public/sounds/mouse-squeak.mp3');
            if (!isSound) {
                _createAudio__WEBPACK_IMPORTED_MODULE_1__.audio.muted;
            }
            else {
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("3bf43bd29b21b9e4d791")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.f24b74bfd3c2fb2d28f3.hot-update.js.map