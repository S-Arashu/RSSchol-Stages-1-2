    ...
    function spinWheel(duration) {
        ...
        function animate(timestamp) {
            ...
            if (timestamp && start) {
                ...
                const speed = easeOutQuad(progress) * (totalDegree - 720);
                const angle = totalDegree - speed;
                ...
                if (progress < 1) {
                    ...
                    const idx = Math.floor(normalizedAngle / (360 / sections.length)) % sections.length;
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("39a9d05e79a35a9151e3")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.6a6df663cc09c984849f.hot-update.js.map