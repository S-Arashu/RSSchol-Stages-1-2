...
function createChoosePage() {
    ...
    let startAngle = 0;
    output.innerText = 'Click "Start" to fun!';
    function drawWheel() {
        if (ctx) {
            ...
            sections.forEach((section, index) => {
                ...
                if (startAngle >= anglePosition && startAngle < anglePosition + angles[index]) {
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("cff6e1b9df67a0a604aa")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.8b8b3c3383881f4a448b.hot-update.js.map