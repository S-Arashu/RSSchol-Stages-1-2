...
function locationHashChanged() {
    ...
    if (location.hash === '#decision-maker') {
        const handleModalClick = (event) => {
            const modalRect = _builders_pasteList__WEBPACK_IMPORTED_MODULE_5__.dialogElem.getBoundingClientRect();
            if (event.clientX < modalRect.left ||
                event.clientX > modalRect.right ||
                event.clientY < modalRect.top ||
                event.clientY > modalRect.bottom) {
                _builders_pasteList__WEBPACK_IMPORTED_MODULE_5__.dialogElem.close();
            }
        };
        _builders_pasteList__WEBPACK_IMPORTED_MODULE_5__.dialogElem.addEventListener('click', handleModalClick);
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("8e9c8b5f9e7888b3cf94")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.7eaa9abd3ef07640fdb5.hot-update.js.map