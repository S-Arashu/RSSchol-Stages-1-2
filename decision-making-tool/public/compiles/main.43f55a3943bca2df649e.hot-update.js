...
title with "quotes",4   -> | title with "quotes"   | 4 |`);
    ...
    confirmBut.addEventListener('click', event => {
        ...
        dataFromTextarea.forEach(arrayElem => {
            ...
            const objData = (0,___WEBPACK_IMPORTED_MODULE_0__.getFromLocalStorage)('dataFromInputs');
            console.log(dataNum);
            if (dataNum) {
                objData[`#${countElem[countElem.length - 1] + 1}`] = (_a = dataNum[0]) === null || _a === void 0 ? void 0 : _a.replace(',', '');
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("6acbcfd0e7dbf6ed8b08")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.43f55a3943bca2df649e.hot-update.js.map