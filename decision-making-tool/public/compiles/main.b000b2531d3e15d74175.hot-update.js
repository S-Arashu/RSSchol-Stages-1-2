...
title with "quotes",4   -> | title with "quotes"   | 4 |`);
    ...
    for (let i = 0; i < NUM_OF_BUTTONS; i += 1) {
        ...
        if (i === 4) {
            ...
            elementOfContainer.after(fileInput);
            elementOfContainer.addEventListener('click', function () {
                fileInput.click();
            });
                    ...
                    if (event.target.files) {
                        ...
                        if (file) {
                            ...
                            reader.onload = e => {
                                var _a, _b;
                                try {
                                    console.log(e.target && ((_a = e.target) === null || _a === void 0 ? void 0 : _a.result) === 'string');
                                    if (e.target && ((_b = e.target) === null || _b === void 0 ? void 0 : _b.result) === 'string') {
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("bd7546cf5c73d76ee537")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.b000b2531d3e15d74175.hot-update.js.map