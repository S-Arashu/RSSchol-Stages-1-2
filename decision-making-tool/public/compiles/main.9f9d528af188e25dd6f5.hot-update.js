...
function createChoosePage() {
    ...
    const sizes = sections.map(section => {
        console.log(options[section[`${section.replace('option-', '#')}`]]);
        return parseInt(options[section.replace('option-#', '')]);
    });
    let startAngle = 0;
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("76ebd404d9e5612e58c4")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.9f9d528af188e25dd6f5.hot-update.js.map