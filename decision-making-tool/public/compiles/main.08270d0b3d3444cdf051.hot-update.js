    ...
    confirmBut.addEventListener('click', event => {
        ...
        dataFromTextarea.forEach(arrayElem => {
            ...
            if (dataNum) {
                ...
                (0,_inputFields__WEBPACK_IMPORTED_MODULE_5__.createInput)(container, countElem[countElem.length - 1], data[0], +((_b = dataNum[0]) === null || _b === void 0 ? void 0 : _b.replace(',', '')));
                textarea.value = '';
            }
    ...
    for (let i = 0; i < NUM_OF_BUTTONS; i += 1) {
        ...
        if (i === 0) {
            elementOfContainer.addEventListener('click', () => {
                ...
                (0,_inputFields__WEBPACK_IMPORTED_MODULE_5__.createInput)(container, numOfElem[numOfElem.length - 1]);
        ...
        if (i === 2) {
            elementOfContainer.addEventListener('click', () => {
                (0,_clearList__WEBPACK_IMPORTED_MODULE_3__.clearList)(container);
            });
        }
    }
}
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("6a0ecf2ed68637a2bdf0")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.08270d0b3d3444cdf051.hot-update.js.map