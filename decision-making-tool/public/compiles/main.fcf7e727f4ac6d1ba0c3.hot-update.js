...
function createInput(parentTag, count) {
    ...
    button.addEventListener('click', () => {
        ...
        if (previous) {
            ...
            if (doublePrevious) {
                let nameOfOption = doublePrevious.getAttributeNames();
                let weightOfOption = previous.value;
                let value = previous.getAttribute(nameOfOption[1]);
                console.log(value);
                console.log(doublePrevious.nameOfOption[1]);
            }
        }
    });
    return liElem;
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("1577427b776cd945583a")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.fcf7e727f4ac6d1ba0c3.hot-update.js.map