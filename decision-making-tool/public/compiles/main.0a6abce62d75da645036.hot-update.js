...
Object(function webpackMissingModule() { var e = new Error("Cannot find module '../sounds/test'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
...
function createChoosePage() {
    ...
    startButton.addEventListener('click', () => {
        ...
        window.setTimeout(() => {
            ...
            Object(function webpackMissingModule() { var e = new Error("Cannot find module '../sounds/createAudio'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())('win', './sounds/sounds_win.mp3');
            Object(function webpackMissingModule() { var e = new Error("Cannot find module '../sounds/test'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
        }, 3000);
    });
    drawWheel();
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("85f725f0e8a2448b6db6")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.0a6abce62d75da645036.hot-update.js.map