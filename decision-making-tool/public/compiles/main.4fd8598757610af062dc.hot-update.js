...
function createChoosePage() {
    ...
    startButton.addEventListener('click', () => {
        if (+timeField.value >= 5 && +timeField.value <= 30) {
            ...
            (0,_createAudio__WEBPACK_IMPORTED_MODULE_1__.createAudio)('squeak', '../sounds/mouse-squeak.mp3');
            if (!isSound) {
                _createAudio__WEBPACK_IMPORTED_MODULE_1__.audio.muted;
            }
            else {
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("877fb01eee066fdc5438")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.4fd8598757610af062dc.hot-update.js.map