...
title with "quotes",4   -> | title with "quotes"   | 4 |`);
    ...
    dialog.addEventListener('cancel', event => {
        ...
        function simulateClick() {
            ...
            _mainBlock__WEBPACK_IMPORTED_MODULE_4__.container.dispatchEvent(event);
        }
        _mainBlock__WEBPACK_IMPORTED_MODULE_4__.container.addEventListener('click', () => {
            console.log('click');
        });
        simulateClick();
        location.hash = 'main';
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("340b5ac625cef61cf307")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.9e27e87bac8fa39f1970.hot-update.js.map