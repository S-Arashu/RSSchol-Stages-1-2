...
title with "quotes",4   -> | title with "quotes"   | 4 |`);
    ...
    confirmBut.addEventListener('click', event => {
        ...
        dataFromTextarea.forEach(arrayElem => {
            ...
            if (countElem) {
                ___WEBPACK_IMPORTED_MODULE_0__.objData[`#${countElem[countElem.length - 1]}`] = dataNum === null || dataNum === void 0 ? void 0 : dataNum.splice(1);
            }
        });
        if (isNaN(lastSymbol)) {
            (0,_dialog__WEBPACK_IMPORTED_MODULE_3__.dialogWrongValue)(container);
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("f627d1c97e30dc8267cb")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.86ac8a9ea3d5b4ddcaab.hot-update.js.map