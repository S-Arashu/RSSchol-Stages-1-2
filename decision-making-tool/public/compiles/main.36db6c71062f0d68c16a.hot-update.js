...
title with "quotes",4   -> | title with "quotes"   | 4 |`);
    ...
    confirmBut.addEventListener('click', event => {
        ...
        dataFromTextarea.forEach(arrayElem => {
            ...
            console.log(___WEBPACK_IMPORTED_MODULE_0__.objData[data[0]]);
            ___WEBPACK_IMPORTED_MODULE_0__.objData[data[0]] = /,[1-9]/.exec(data[1]);
        });
        if (isNaN(lastSymbol)) {
            (0,_dialog__WEBPACK_IMPORTED_MODULE_3__.dialogWrongValue)(container);
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("f4241970b0c62cb2766f")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.36db6c71062f0d68c16a.hot-update.js.map